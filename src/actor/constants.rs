...
pub const THRUST_CONE_HALF_ANGLE: f32 = 0.25;
pub const THRUST_LINE_COUNT: usize = 6;
pub const THRUST_LINE_LENGTH_BASE: f32 = 12.0;
pub const THRUST_LINE_LENGTH_VARIANCE: f32 = 4.0;
pub const THRUST_LINE_OFFSET: f32 = 3.0;
pub const THRUST_LINE_WIDTH: f32 = 2.5;
pub const THRUST_VIBRATION_AMPLITUDE: f32 = 0.4;
pub const THRUST_VIBRATION_SPEED: f32 = 25.0;
