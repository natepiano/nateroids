...
pub use global_shortcuts::InspectAabbConfigSwitch;
pub use global_shortcuts::InspectBoundarySwitch;
pub use global_shortcuts::InspectCameraConfigSwitch;
pub use global_shortcuts::InspectFocusConfigSwitch;
...
pub use global_shortcuts::InspectStarConfigSwitch;
pub use global_shortcuts::InspectZoomConfigSwitch;
pub use global_shortcuts::PauseSwitch;
